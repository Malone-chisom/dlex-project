...
const Info = () => {
    return (
        <div className='  w-[22%]  flex-col justify-center h-[95vh] bg-[#F5F5F5] hidden medium:block'>
            <div className='flex gap-4 flex-col items-center'>
                <div className='flex flex-col items-center '>
                    <div className='flex items-center flex-col gap-1 '>
                        <div><img src={assets.Group1002} alt="" /></div>
                ...
                <div className=' flex sm:min-w-[95%] w-[80%] justify-co flex-col justify-between'>
                    ...
                    <h1 className=' font-medium  mb-2 mt-4'>Course Progress</h1>
                    <div className='flex flex-col gap-10 md:gap-3 md:text-sm'>
